...
def classify_images(images_dir, petlabel_dic, model):
    ...
    for key in petlabel_dic:
       ...
       # "cat" matching to "tabby cat"
           ...
           # a match - if so they are added to results_dic as a match and searching
           #through the for loop is terminated using the break
           for term in model_label_list:
               ...
               # then the results are added to results_dic and break is
               # used to break out of the for loop since a match was found
               if truth in word_list:
                   results_dic[key] = [truth, model_label, 1]
                   break
